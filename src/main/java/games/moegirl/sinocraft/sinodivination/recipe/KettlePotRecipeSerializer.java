...
import games.moegirl.sinocraft.sinocore.api.crafting.ingredient.FluidIngredientSerializer;
...
public final class KettlePotRecipeSerializer extends AbstractRecipeSerializer<KettlePotRecipe> {
    ...
    public KettlePotRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
        ...
        FluidIngredient fluid = FluidIngredientSerializer.INSTANCE.fromJson(pSerializedRecipe.getAsJsonObject("fluid"));
    ...
    public KettlePotRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        FluidIngredient fluid = FluidIngredientSerializer.INSTANCE.fromNetwork(pBuffer);
    ...
    public void toJson(JsonObject pJson, KettlePotRecipe pRecipe) {
        ...
        pJson.add("fluid", FluidIngredientSerializer.INSTANCE.write(new JsonObject(), pRecipe.fluid));
    ...
    public void toNetwork(FriendlyByteBuf pBuffer, KettlePotRecipe pRecipe) {
        ...
        FluidIngredientSerializer.INSTANCE.write(pBuffer, pRecipe.fluid);
