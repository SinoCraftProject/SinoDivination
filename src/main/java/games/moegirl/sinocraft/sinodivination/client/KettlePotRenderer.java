...
import games.moegirl.sinocraft.sinocore.api.utility.texture.RenderTypes;
...
//            VertexConsumer buffer = bufferSource.getBuffer(new RenderTypes(texture).renderTypeWithColorLightmapTransparency.get());
