...
import games.moegirl.sinocraft.sinocore.api.utility.OptionalTag;
...
public class KettlePotProcessor extends RecipeProcessor<KettlePotEntity, RecipeContainer, KettlePotRecipe> {

    private Ingredient container = Ingredient.EMPTY;
    private ItemStack result = ItemStack.EMPTY;
    private final KettlePotEntity entity;

    public KettlePotProcessor(RecipeHolder<RecipeContainer, KettlePotRecipe, ?> holder, KettlePotEntity entity) {
        super(holder, false);
        this.entity = entity;
    }
    ...
    protected Optional<KettlePotRecipe> trySetRecipe() {
        ...
        RecipeContainer container = RecipeContainer.create(input.getInv(), entity.getTank());
